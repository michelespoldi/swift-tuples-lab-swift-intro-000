 ...
 */
let human = (name: "Mike", age: 67)

/*:
 ### 10. Can you change `human`'s age? Why or why not?
 */
//unable to cheange a constant value once declared
